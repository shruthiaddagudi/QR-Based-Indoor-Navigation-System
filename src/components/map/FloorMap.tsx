...
interface FloorMapProps {
  ...
  onSetDestination?: (roomId: string | null) => void;
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex gap-1.5 shrink-0">
              <button
                ...
                className="px-2 py-1.5 text-slate-400 hover:text-white text-xs rounded-lg border border-slate-700/50 transition-colors"
                title="Close"
              >
                ✕
              </button>
              <button
                className="px-2.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold rounded-lg transition-colors border border-slate-700/50"
                onClick={() => {
                  onSetNavMode?.(true);
              ...
              <button
                className="px-2.5 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold rounded-lg transition-colors shadow-lg shadow-indigo-500/25"
                onClick={() => {
                  onSetNavMode?.(true);
                  onSetDestination?.(selectedRoom);
                  onSetHighlightedRoom?.(null);
                }}
              >
                Set End
